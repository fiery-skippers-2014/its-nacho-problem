...
describe RecipesController do
  let(:result) {[
      ...
      "attributes"=>{"course"=>["Appetizers"]}, "totalTimeInSeconds"=>nil, "rating"=>5, "recipeName"=>"Roasted Escargots, Butter, Oregano, Parsley", "sourceDisplayName"=>"Saveur", "id"=>"Roasted-Escargots_-Butter_-Oregano_-Parsley-442738"},
      {"attributes"=>{}, "flavors"=>nil, "rating"=>5, "id"=>"Escargots-a-la-Bourguignonne-Food-Network-247669", "smallImageUrls"=>[], "sourceDisplayName"=>"Food Network", "totalTimeInSeconds"=>2700.0, "ingredients"=>["shallots", "celery", "escargot", "onion", "snails", "garlic", "bouquet garni", "softened butter", "carrots", "dry white wine", "salt", "white vinegar", "chopped parsley", "red wine", "black ground pepper", "snail shells"], "recipeName"=>"Escargots a la Bourguignonne"},
      {"attributes"=>{"course"=>["Appetizers"], "cuisine"=>["french"]}, "flavors"=>{"sour"=>1.0, "salty"=>0.16666666666666666, "sweet"=>0.3333333333333333, "meaty"=>0.3333333333333333, "bitter"=>0.8333333333333334}, "rating"=>4, "id"=>"Escargot-Classic-Style-Food_com-124991", "smallImageUrls"=>[], "sourceDisplayName"=>"Food.com", "totalTimeInSeconds"=>600.0, "ingredients"=>["pepper", "escargot", "heavy cream", "garlic cloves", "unsalted butter", "flat leaf parsley", "salt"], "recipeName"=>"Escargot Classic Style"}
      ]}
